...
export const metadata: Metadata = pageMeta({
  title: "Our Story",
  description: "Fragrances by Hameemah blends long-lasting, luxury perfumes for Pakistan — made in small batches with premium oils.",
  path: "/about",
});
  ...
  return (
    <>
      ...
      <section className="mx-auto grid max-w-6xl items-center gap-12 px-5 py-20 lg:grid-cols-2 lg:py-28">
        <Reveal className="relative mx-auto aspect-square w-full max-w-md overflow-hidden rounded-[2rem] bg-gradient-to-b from-emerald to-ink">
          <Image src="/photos/bottles-group.webp" alt="Fragrances by Hameemah perfume bottles with crystal caps and gold collars" fill priority sizes="(max-width:768px) 100vw, 448px" className="object-cover" />
        </Reveal>
        <div>
          ...
          <Reveal delay={0.2}>
            ...
            <p className="mt-4 leading-relaxed text-ink/80">From fresh everyday scents to warm amber and smoky leather, each fragrance is blended with care, matured patiently and bottled in our signature octagonal glass with a crystal cap and gold collar.</p>
