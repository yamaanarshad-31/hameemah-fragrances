        ...
        <Card className="self-start">
          ...
          <form action={saveCategory} className="mt-4 space-y-3">
            ...
            <div className="flex gap-3">
              ...
              <label className="block flex-1"><span className={labelCls}>Order</span><input name="sort" type="number" defaultValue={cats.length + 1} className={`${inputCls} mt-1`} /></label>
            </div>
            <button className="btn-gold w-full rounded-xl py-3 text-sm font-bold">Add category</button>
          </form>
        </Card>
      </div>
    </>
